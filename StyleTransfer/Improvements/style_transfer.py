...
width, height = load_img("matthia.jpg").size
img_nrows = 400
...
base_image = K.variable(load_image("matthia.jpg"))
style_reference_image = K.variable(load_image("munch.jpg"))
