...
IMAGE_PATH = "/data/s2847485/PhD/images/"
LABELS_PATH = "/data/s2847485/PhD/labels/"
...
class CNN(object):
	...
	def load_images(self):
		return np.load(IMAGE_PATH+"images.npy")

	def load_labels(self):
		return np.load(LABELS_PATH+"total_type_labels.npy")
